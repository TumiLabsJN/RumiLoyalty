-- Patch: Fix claim_commission_boost missing client_id in INSERT
-- This patches the remote database where 20251226210000_recurring_scheduled_rewards.sql
-- was applied without client_id in commission_boost_redemptions INSERT.
...
BEGIN
  ...
  -- Existing boost logic: Insert commission_boost_redemptions (with client_id fix)
