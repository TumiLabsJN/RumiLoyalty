...
- [ ] **Task 8.4.1:** Create cron integration tests
...
- [ ] **Task 8.4.3:** Test daily automation updates user metrics
...
- [ ] **Task 8.4.3a:** Test RPC function behaviors (vip_metric branching, call sequence, mission progress RPCs)
...
- [ ] **Task 8.4.5:** Test tier calculation correct thresholds
...
- [ ] **Task 8.4.6:** Test tier promotion shows new rewards immediately
...
- [ ] **Task 8.4.7:** Test tier demotion soft-deletes VIP rewards
...
- [ ] **Task 8.4.8:** Test scheduled activation at correct time
